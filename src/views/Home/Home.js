...
export default function Home() {
  ...
  return (
      ...
      <Paper style={backgroundstyles.paperContainer}>
        <CardBody>
        <div >
          <h1 className={classes.cardTitleWhite}><b>Hello World</b> </h1>
        </div>
        <div>
        
          <h3 className={classes.cardTitleWhite}> This is Lihong's Small World</h3>
        </div>
        <div>
        
          <h4 className={classes.cardTitleWhite}> Software developer as my career</h4> 
